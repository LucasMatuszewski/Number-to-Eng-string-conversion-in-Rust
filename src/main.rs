...
// Original function generated by ChatGPT-4o output scale words in a wrong place, like:
...
// Third fixes made by GPT-4o resulted in same error, because it didn't fix it at all...
// Instead of adding `clone()` it broke the code by mixing the values again...
// I didn't implement that changes...

// ---------

// I HAVE FIXED THE CODE MANUALLY just by adding `chunk_words.clone();` as Error sugested.
// This was the only manual change in code I did.

// Below code works as expeted:
